...
const servicesHealth_controller_1 = require("../controllers/servicesHealth.controller");
 ...
 */
router.get("/:id", filterId_1.validarFiltrarId, resultValidator_1.validarResultado, servicesHealth_controller_1.procurarServiceHealth);
